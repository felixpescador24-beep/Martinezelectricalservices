...
<head>
  ...
  <style>
    ...
    * {margin:0;padding:0;box-sizing:border-box;font-family:Arial, sans-serif;}
    ...
    /* HERO */
    header {
      background:linear-gradient(rgba(15,23,42,0.8), rgba(15,23,42,0.8)), url('https://via.placeholder.com/1600x900') center/cover no-repeat;
      min-height:100vh;
      display:flex;
      align-items:center;
    ...
    /* GRID CARDS */
    .services-grid, .why-grid, .areas-grid {
      display:grid;
